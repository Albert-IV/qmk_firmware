...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] =  LAYOUT(
        ...
        LCTL_T(KC_Z), KC_X,    LALT_T(KC_C),     LGUI_T(KC_V),      KC_B,                        KC_N,            RGUI_T(KC_M),   RALT_T(KC_COMM),   KC_DOT,  RCTL_T(KC_SLSH),
                                                                    KC_MUTE,                     XXXXXXX,
                               XXXXXXX,          LT(_NUM,KC_ESC),   LT(_SYMB,KC_BSPC),           LT(_NUM,KC_SPC), LT(_SYMB,KC_ENT), XXXXXXX
    ),
/*
 * ,----------------------------------.                              ,----------------------------------.
 * |   !  |   @  |   `  |   +  |   /  |                              |   \  |   &  |   ~  |   =  |   |  |
 ...
 */
    ...
    [_NUM] = LAYOUT(
        ...
        KC_LSFT, XXXXXXX, XXXXXXX, KC_MUTE, KC_VOLU,                      KC_LEFT, KC_DOWN,         KC_UP,           KC_RGHT, KC_RSFT,
        KC_LCTL, XXXXXXX, KC_LALT, KC_LGUI, KC_VOLD,                      KC_HOME, RGUI_T(KC_PGDN), RALT_T(KC_PGUP), KC_END,  KC_RCTL,
                                            XXXXXXX,                      XXXXXXX,
