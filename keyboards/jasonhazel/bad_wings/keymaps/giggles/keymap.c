...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DEF] = LAYOUT(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                          KC_ESC,  KC_LSFT, LA_NAV, LA_SYM,  KC_SPC,  KC_ENTER
    ),

    [SYM] = LAYOUT(
        KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE,KC_NO,   KC_UNDS, KC_NO,   KC_NO,   KC_BSLS,
        KC_HASH, KC_DLR,  KC_LPRN, KC_RPRN, KC_GRV, KC_PLUS, KC_MINS, KC_PERC, KC_ASTR, KC_SCLN,   
        KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD,KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_SLSH, 
                     LSFT(KC_TAB), KC_TAB,  _______,_______, _______, _______
    ),
    ...
    [NAV] = LAYOUT(
        ...
        SPC_L,   SPC_D,   SPC_U,   SPC_R,   KC_VOLD, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_DEL,
                          _______, _______, _______, _______, KC_TAB,  LSFT(KC_TAB)
    ),
